...
namespace Negocio
{
    public class PokemonNegocio
    {
        ...
        public void Agregar(Pokemon pokemonNew)
        {
            ...
            try
            {
                dato.setQuery($"Insert into Pokemons (Numero, Nombre, Descripcion, Activo, IdTipo, IdDebilidad, UrlImagen) Values ({pokemonNew.Numero}, '{pokemonNew.Nombre}', '{pokemonNew.Descripcion}', 1, {pokemonNew.Tipo.Id}, {pokemonNew.Debilidad.Id}, @urlImagen)");
